...
const SSD1309_INIT_SEQ_2 = [
    2,                                      // 2 commands
    SSD1309_SET_DISPLAY_OFFSET,     0x01,   // Set Display Offset
        0x00,                               // sets offset pro to 0
    SSD1309_SET_START_LINE | 0x00,  0x00,   // Line #0 - No Args, no delay.
];
...
class Adafruit_SSD1309 extends Display_Base {
    ...
    */
    ...
    begin() {
        ...
        self._executeInitSequence(SSD1309_INIT_SEQ_4);
    ...
    */
    ...
    display() {
        ...
        // write buffer data
        self._ssd1309_data(self._buffer);
        return self;
    }
